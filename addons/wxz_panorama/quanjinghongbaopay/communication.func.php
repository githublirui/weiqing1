...
define('HONGBAO_MCHID', $this->module['config']['pay']['mchid']);
define('HONGBAO_PASSWORD', $this->module['config']['pay']['key']);
define('HONGBAO_APPID', $this->module['config']['pay']['appid']);

define('HONGBAO_PROVIDER', '全景红包');
define('HONGBAO_WISH', '全景红包');
//define('HONGBAO_IP', '139.224.2.158');
define('HONGBAO_TITLE', $this->module['config']['active_name']);
define('HONGBAO_REMARK', '全景红包');
