    ...
    if (isset($sceneTreasure[$i])) {
        for ($k = 0; $k < $sceneTreasure[$i]; $k++) {
            $attributes = array(
                ...
                'ry' => "",
                'rx' => "",
                'onclick' => "openurl(" . urldecode($_W['siteroot'] . "app/index.php?i=" . $_W['uniacid'] . "&amp;pid=" . $pid . "&amp;c=entry&amp;do=award&amp;m=" . $_GPC['m'] . "&amp;aid=" . $projectInfo['aid']) . ");",
...
if ($projectConfigInfo['config']['bottombanner'] == 1 || is_null($projectConfigInfo['config']['bottombanner'])) {
//底部三个按钮
    ...
    $krpanoElement .= '<plugin name="ui308" url="%SWFPATH%/ui/1446496249stEUWG.png" zorder="100" alpha="0.8" align="bottom" x="0" y="65" ox="0" oy="0" width="" height="" scale="1" visible="True" enabled="True" capture="True" keep="True" showpic="" onclick="openurl(' . urldecode($_W['siteroot']) . 'app/index.php?i=' . $_W['uniacid'] . '&amp;c=entry&amp;do=win&amp;m=wxz_panorama&amp;aid=' . $projectInfo['aid'] . ',_blank);" onhover="" />';
    ...
    $krpanoElement .= '<plugin name="ui336" url="%SWFPATH%/ui/1446480271IGFbwF.png" zorder="100" alpha="1" align="righttop" x="0" y="0" ox="0" oy="0" width="" height="" scale="1" visible="True" enabled="True" capture="True" keep="True" showpic="" onclick="openurl(' . urldecode($_W['siteroot']) . 'app/index.php?i=' . $_W['uniacid'] . '&amp;aid='.$projectInfo['aid'].'&amp;pid=' . ($next_project['id']) . '&amp;c=entry&amp;do=quanjing&amp;m=wxz_panorama,_blank);" onhover="" />';
}
//krpano 属性
$attributes = array(
...
//兼容手机
$attributes['devices'] = 'mobile.or.desktop';
