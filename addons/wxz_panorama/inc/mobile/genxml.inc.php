    ...
    if (isset($sceneTreasure[$i])) {
        for ($k = 0; $k < $sceneTreasure[$i]; $k++) {
            $attributes = array(
                ...
                'ry' => "",
                'rx' => "",
                'onclick' => "openurl(" . urldecode($_W['siteroot'] . "app/index.php?i=" . $_W['uniacid'] . "&amp;pid=" . $pid . "&amp;c=entry&amp;do=award&amp;m=" . $_GPC['m'] . "&amp;aid=" . $projectInfo['aid']) . ",_blank);",
...
//底部三个按钮
    ...
    $krpanoElement .= '<plugin name="ui308" url="%SWFPATH%/ui/1446496249stEUWG.png" zorder="100" alpha="0.8" align="bottom" x="0" y="65" ox="0" oy="0" width="" height="" scale="1" visible="True" enabled="True" capture="True" keep="True" showpic="" onclick="openurl(' . urldecode($_W['siteroot']) . 'app/index.php?i=' . $_W['uniacid'] . '&amp;c=entry&amp;do=win&amp;m=wxz_panorama,_blank);" onhover="" />';
