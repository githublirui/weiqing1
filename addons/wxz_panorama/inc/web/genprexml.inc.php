...
//底部三个按钮
 ...
 $krpanoElement .= '<plugin name="ui308" url="%SWFPATH%/ui/1446496249stEUWG.png" zorder="100" alpha="0.8" align="bottom" x="0" y="65" ox="0" oy="0" width="" height="" scale="1" visible="True" enabled="True" capture="True" keep="True" showpic="" onclick="openurl(' . urldecode($_W['siteroot']) . 'app/index.php?i=' . $_GET['i'] . '&amp;c=entry&amp;do=win&amp;m=wxz_quanjing,_blank);" onhover="" />';
