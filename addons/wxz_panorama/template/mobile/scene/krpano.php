...
<scene name="scene" scenetitle="{$scenetitle}" thumburl="%SWFPATH%/images/thumb.jpg" nowpic="" onstart="thumb_start(1);set(control.mousetype, moveto);" >
...
<left url="%SWFPATH%/images/pano_left.jpg" />
<front url="%SWFPATH%/images/pano_front.jpg" />
<right url="%SWFPATH%/images/pano_right.jpg" />
<back url="%SWFPATH%/images/pano_back.jpg" />
<up url="%SWFPATH%/images/pano_up.jpg" />
<down url="%SWFPATH%/images/pano_down.jpg" />
<mobile>
<left url="%SWFPATH%/images/mb_left.jpg" />
<front url="%SWFPATH%/images/mb_front.jpg" />
<right url="%SWFPATH%/images/mb_right.jpg" />
<back url="%SWFPATH%/images/mb_back.jpg" />
<up url="%SWFPATH%/images/mb_up.jpg" />
<down url="%SWFPATH%/images/mb_down.jpg" />
</mobile>
<tablet>
<left url="%SWFPATH%/images/tb_left.jpg" />
<front url="%SWFPATH%/images/tb_front.jpg" />
<right url="%SWFPATH%/images/tb_right.jpg" />
<back url="%SWFPATH%/images/tb_back.jpg" />
<up url="%SWFPATH%/images/tb_up.jpg" />
<down url="%SWFPATH%/images/tb_down.jpg" />
</tablet>
</image>
<hotspot name="spot1" devices="all" url="%SWFPATH%/spot/1446487094CA8Llf.png" capture="False" enabled="True" visible="True" rotatewithview="False" distorted="True" smoothing="True" scale="0.5999999999999996" atv="' . (rand(-500, 500)) . '" ath="' . (rand(-500, 500)) . '" rz="0" ry="0" rx="0" onclick="openurl(' . urldecode($_GET['siteroot']) . 'app/index.php?i=' . $_GET['i'] . '&amp;pno=' . $_GET['pno'] . '&amp;c=entry&amp;do=award&amp;m=wxz_panorama,_self);" onhover="set(hotspot[spot1info].visible,true);" onover="" onout="" />
...
<plugin name="ui110" url="%SWFPATH%/ui/1446496263mLdRAa.png" zorder="100" alpha="0.8" align="leftbottom" x="20" y="65" ox="0" oy="0" width="" height="" scale="1" visible="True" enabled="True" capture="True" keep="True" showpic="" onclick="ifnot(uishowpic === null , set(plugin[get(uishowpic)].y,-8000););set(uishowpic,uishowpic110);set(plugin[uishowpic110].y,0);tween(plugin[uishowpic110].alpha,1,0.1);" onhover="" />
<plugin type="image" name="uishowpic110" url="%SWFPATH%/showpic/1446498593ZQeTis.png" zorder="1000" alpha="1.0" blendmode="NORMAL" align="center" edge="center" x="0" y="-8000" width="" height="" scale="1" smoothing="True" visible="True" enabled="True" capture="False" handcursor="True" keep="True" children="True" preload="false" scalechildren="True" onclick="tween(alpha,0,0.1);tween(y,-8000);" effect="glow(0xffffff,0.5,10,100);" />
<plugin name="ui111" url="%SWFPATH%/ui/1446496249stEUWG.png" zorder="100" alpha="0.8" align="bottom" x="0" y="65" ox="0" oy="0" width="" height="" scale="1" visible="True" enabled="True" capture="True" keep="True" showpic="" onclick="openurl(' . urldecode($_GET['siteroot']) . 'app/index.php?i=' . $_GET['i'] . '&amp;pno=' . $_GET['pno'] . '&amp;c=entry&amp;do=win&amp;m=wxz_panorama,_self);" onhover="" />
<plugin name="ui112" url="%SWFPATH%/ui/1446496235PrVGc0.png" zorder="100" alpha="0.8" align="rightbottom" x="10" y="65" ox="0" oy="0" width="" height="" scale="1" visible="True" enabled="True" capture="True" keep="True" showpic="" onclick="ifnot(uishowpic === null , set(plugin[get(uishowpic)].y,-8000););set(uishowpic,uishowpic112);set(plugin[uishowpic112].y,0);tween(plugin[uishowpic112].alpha,1,0.1);" onhover="" />
<plugin type="image" name="uishowpic112" url="%SWFPATH%/showpic/1446496682Tuc2Yw.png" zorder="1000" alpha="1.0" blendmode="NORMAL" align="center" edge="center" x="0" y="-8000" width="" height="" scale="1" smoothing="True" visible="True" enabled="True" capture="False" handcursor="True" keep="True" children="True" preload="false" scalechildren="True" onclick="tween(alpha,0,0.1);tween(y,-8000);" effect="glow(0xffffff,0.11,10,100);" />
<plugin name="ui113" url="%SWFPATH%/ui/1446498065z0nkqD.png" zorder="100" alpha="1" align="bottom" x="0" y="7" ox="0" oy="0" width="" height="" scale="1" visible="True" enabled="True" capture="True" keep="True" showpic="" onclick="openurl(tel:13956993061,_blank);" onhover="" />
<plugin name="ui134" url="%SWFPATH%/ui/1446480271IGFbwF.png" zorder="100" alpha="1" align="righttop" x="0" y="0" ox="0" oy="0" width="" height="" scale="1" visible="True" enabled="True" capture="True" keep="True" showpic="" onclick="openurl(' . urldecode($_GET['siteroot']) . 'app/index.php?i=' . $_GET['i'] . '&amp;pno=' . ($_GET['pno']+1) . '&amp;c=entry&amp;do=quanjing&amp;m=wxz_panorama,_self);" onhover="" />
