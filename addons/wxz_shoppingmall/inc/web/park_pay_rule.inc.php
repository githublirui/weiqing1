...
if (checksubmit()) {
    ...
    $settings['park_pay_type_time_credit'] = (int) $_GPC['park_pay_type_time_credit']; //2.按时收费 抵扣积分
    $settings['park_pay_type_discount'] = (int) $_GPC['park_pay_type_discount']; //3.微信现金 
    //停车场设置
