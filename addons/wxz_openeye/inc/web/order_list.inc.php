...
require_once WXZ_OPENEYE . '/source/Order.class.php';
...
$sql = "SELECT count(*) as num FROM " . tablename('wxz_openeye_order') . " WHERE {$condition}";
$total = pdo_fetchcolumn($sql, $pars);

$sql = "SELECT * FROM " . tablename('wxz_openeye_order') . " WHERE {$condition} ORDER BY `create_at` DESC limit $start , $psize";
