...
if (checksubmit('submit')) {
	...
	switch($type){
		...
		case 6:
			...
			break;
		case 7:
			$setting['pic'] = $_GPC['pic'];
			$setting['images'] = "<img src='".tomedia($_GPC['pic'])."' width='100%' height='100%'>";
			break;
		case 8:
			$setting['xsdroomid'] = $_GPC['xsdroomid'];
			break;
		case 4:
		...
		case 5:
			...
			break;
		case 9:
			$setting['sid'] = $_GPC['sid'];
			$setting['ssid'] = $_GPC['ssid'];
			$setting['tpl'] = $_GPC['tpl'];
			break;
	}
