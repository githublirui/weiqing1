...
if (checksubmit('submit')) {
	...
	$setting['remark1'] = $_GPC['remark1'];
	$setting['remark2'] = $_GPC['remark2'];
	$setting['remark3'] = $_GPC['remark3'];
	$setting['remark4'] = $_GPC['remark4'];
	$setting['remark5'] = $_GPC['remark5'];
	$setting['remark6'] = $_GPC['remark6'];
