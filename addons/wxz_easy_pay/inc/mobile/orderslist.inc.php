...
if($_GPC['order_status']){
	if($search){
		$sql = 'SELECT u.nickname as nickname,o.order_status as order_status,p.goodsName as goodsName,o.id as id,p.goodsImg as goodsImg,o.buy_nick as buy_nick, o.cell as cell,o.address as address,o.pay_time as pay_time FROM ' . tablename('hangyi_order')." as o left join ". tablename('core_paylog')." as  pl on o.id=pl.tid left join ". tablename('hangyi_product')." as  p on o.pid=p.id left join ". tablename('hangyi_user')." as u on u.uid=o.buy_id WHERE o.sell_id = :uid and pl.`status`='1'  and pl.`module`='wxz_easy_pay' and pl.uniacid=:uniacid and o.`order_status`='".$_GPC['order_status']."' and (p.goodsName like '%".$search."%' or u.nickname like '%".$search."%' or o.buy_nick like '%".$search."%')  order by o.id desc";
	}else{
		$sql = 'SELECT u.nickname as nickname,o.order_status as order_status,p.goodsName as goodsName,o.id as id,p.goodsImg as goodsImg,o.buy_nick as buy_nick, o.cell as cell,o.address as address,o.pay_time as pay_time FROM ' . tablename('hangyi_order')." as o left join ". tablename('core_paylog')." as  pl on o.id=pl.tid left join ". tablename('hangyi_product')." as  p on o.pid=p.id left join ". tablename('hangyi_user')." as u on u.uid=o.buy_id WHERE o.sell_id = :uid and pl.`status`='1' and pl.`module`='wxz_easy_pay' and pl.uniacid=:uniacid and o.`order_status`='".$_GPC['order_status']."'  order by o.id desc";
	}
}else{
	if($search){
		$sql = 'SELECT u.nickname as nickname,o.order_status as order_status,p.goodsName as goodsName,o.id as id,p.goodsImg as goodsImg,o.buy_nick as buy_nick, o.cell as cell,o.address as address,o.pay_time as pay_time FROM ' . tablename('hangyi_order')." as o left join ". tablename('core_paylog')." as  pl on o.id=pl.tid left join ". tablename('hangyi_product')." as  p on o.pid=p.id left join ". tablename('hangyi_user')." as u on u.uid=o.buy_id WHERE o.sell_id = :uid and pl.`status`='1' and pl.`module`='wxz_easy_pay' and pl.uniacid=:uniacid and (p.goodsName like '%".$search."%' or u.nickname like '%".$search."%' or o.buy_nick like '%".$search."%') order by o.id desc";
...
$trades_or = pdo_fetchall($sql, $pars);
