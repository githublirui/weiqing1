<?php
require_once IA_ROOT."/addons/wxz_easy_pay/pay/lib/WxPay.Exception.php";
require_once IA_ROOT."/addons/wxz_easy_pay/pay/lib/WxPay.Config.php";
require_once IA_ROOT."/addons/wxz_easy_pay/pay/lib/WxPay.Data.php";
...
class WxPayApi
{
	...
	{		
		...
		if($useCert == true){
			...
			curl_setopt($ch,CURLOPT_SSLCERT, IA_ROOT.WxPayConfig::SSLCERT_PATH);
			curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
			curl_setopt($ch,CURLOPT_SSLKEY, IA_ROOT.WxPayConfig::SSLKEY_PATH);
		}
		//post提交方式
